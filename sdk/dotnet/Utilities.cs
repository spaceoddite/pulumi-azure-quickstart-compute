...
namespace Pulumi.Azure-quickstart-compute
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Azure-quickstart-compute.version.txt");
    ...
    internal sealed class Azure-quickstart-computeResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Azure-quickstart-computeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
